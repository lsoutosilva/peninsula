...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en-US"> <!--<![endif]-->
    ...
    <!-- Mirrored from healthpress.inspirythemes.com/4-columns-doctors/ by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 22 Jul 2013 03:11:20 GMT -->
    <!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
    <? include 'head.php'; ?>
    <body class="page page-id-52 page-template page-template-template-doctors-four-columns-php">				
        ...
        <div id="wrapper">
            ...
            <hgroup class="page-head"> 
                ...
                <h1>Nossos <span>Médicos</span></h1>
    ...
    <!-- Mirrored from healthpress.inspirythemes.com/4-columns-doctors/ by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 22 Jul 2013 03:11:21 GMT -->
</html>	  
